...
const Footer = () => {
  return (
    <footer data-theme="dark" className="footer footer-center p-10 bg-primary text-primary-content">
      <div>
        <h1 className='text-2xl font-mono italic font-bold'>Cesar<span className='text-green-600'>Photography</span></h1>
